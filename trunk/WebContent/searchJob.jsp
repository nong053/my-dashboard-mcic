...
query+=" WHERE WDJ.PROGRAM_ID IS NULL    AND WDJ.REQUEST_ID IS NULL AND (WDJ.STATUS_TYPE = 4 OR WDJ.STATUS_TYPE =3) AND FIRST_UNIT_START_DATE between sysdate-7 AND sysdate AND WEI.WIP_ENTITY_NAME like '%"+paramSearch+"%'";
