...
var grid = function(gridName,gridData){
 ...
 $(gridName).kendoGrid({
              ...
              $("#grid1 tbody tr").each(function(){
            	 ...
            	 $("td:eq(8)",this).css({"text-align":"right","padding-right":"10px"}); 
              });
			   ...
			   success:function(data){
				   ...
				   $.each(data,function(index,intryIndex){
					  ...
					  $.ajax({
						 url:'next_job.jsp',
						 datayType:'json',
						 data:{"paramNextJobNumber":intryIndex[8]},
						 success:function(data){
							 //alert(data[0][0]);
						 }
					  });
					  gridData+="\"NextJob\":\""+intryIndex[8]+"\"";
...
$("#submitSearh").click(function(){
	...
	$("#searchGrid").empty();
	callAjaxProductionProgress("production_search.jsp","#searchGrid",$("#search1").val());
