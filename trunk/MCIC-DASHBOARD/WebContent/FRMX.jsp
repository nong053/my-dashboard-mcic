...
String query = ""; 
query+="SELECT WEI.WIP_ENTITY_NAME, MSI.segment1, MSI.DESCRIPTION, WOV.FIRST_UNIT_START_DATE, WDJ.STATUS_TYPE, WOV.OPERATION_CODE,WDJ.START_QUANTITY,WOV.QUANTITY_COMPLETED";
...
query+="  WHERE  WOV.OPERATION_SEQ_NUM = 20 AND WOV.OPERATION_CODE like 'F%' AND (WDJ.STATUS_TYPE = 4 OR WDJ.STATUS_TYPE =3) AND MSI.ORGANIZATION_ID = 104 AND WDJ.PROGRAM_ID IS NULL AND WDJ.REQUEST_ID IS NULL AND FIRST_UNIT_START_DATE between sysdate-15 AND sysdate AND WOV.OPERATION_CODE  like '%"+paramDepartment+"%' ORDER BY FIRST_UNIT_START_DATE ASC";
...
JSONArray arrayObj_sub=new JSONArray();
 ...
 arrayObj_sub.add(rs.getString("QUANTITY_COMPLETED"));
