...
var dataSlideDown1=function(numDown){   
    ...
    console.log("numDown>-$hieght" +numDown+"$hieght"+ -$hieght);
    if(numDown>-$hieght){
...
var dataSlideDown2=function(numDown){
    ...
    if(numDown>-$hieght){
    	...
    	//alert("slide 2 run is sucess please require data ans slide above again");
...
var dataSlideDown3=function(numDown){
    ...
    if(numDown>-$hieght){
    	...
    	//alert("slide 3 run is sucess please require data ans slide above again");
 ...
 $(gridName).kendoGrid({
			...
			var numJobReleased4 =0;
              $.each(gridData,function(index,indexIntry){
          	  ...
          	  if ((indexIntry['Quantity_Completed']!="") && (indexIntry['Quantity_Completed']!="null"))
	  			  {
		...
		$.ajax({
			   ...
			   success:function(data){
				   ...
				   $.each(data,function(index,intryIndex){
					  ...
					  gridData+="\"Quantity_Completed\":\""+intryIndex[5]+"\"";
					  gridData+="}";
					  i++;
				   });
					gridData+="]";
